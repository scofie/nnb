...
class Base extends Controller
{
	...
	public function initialize()
	{
		...
		// 无需登录的方法
		$except = ['Index/index', 'Account/signin', 'Account/signup', 'Account/check', 'Account/forgot', 'Service/exchange', 'Service/sms', 'Service/sms_check', 'Service/captcha', 'Oauth/qq_login', 'Oauth/qq_callback'];
		// 当前路由
