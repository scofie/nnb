<?php /*a:2:{s:66:"/www/wwwroot/sl.g8ym.com/application/index/view/index/contact.html";i:1581830132;s:65:"/www/wwwroot/sl.g8ym.com/application/index/view/common/world.html";i:1630392347;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<div class="card">
    <ul class="list-group card-list-group messages">
        ...
        <li class="list-group-item px-3">
            <div class="media">
                <div class="media-object avatar avatar-md mr-3" style="background-image: url(<?php echo avatar(app('session')->get('user.profile.avatar'), app('session')->get('user.profile.idcard')); ?>);"></div>
                <div class="media-body">
                    <div class="media-heading">
                        <small class="float-right text-muted"><?php echo htmlentities($msg['create_at']); ?></small>
                        <h5><?php echo htmlentities(app('session')->get('user.profile.nickname')); ?></h5>
                    </div>
                    <div><?php echo htmlentities($msg['content']); ?></div>
                    <?php if(!(empty($msg['reply']) || (($msg['reply'] instanceof \think\Collection || $msg['reply'] instanceof \think\Paginator ) && $msg['reply']->isEmpty()))): ?>
                    <ul class="media-list">
                        <li class="media mt-4">
                            <div class="media-object avatar mr-3" style="background-image: url(/static/image/icon.png);"></div>
                            <div class="media-body">
                                <strong>系统回复：</strong>
                                <?php echo htmlentities($msg['reply']); ?>
                            </div>
                        </li>
                    </ul>
                    <?php endif; ?>
...
// 用户头像
var avatar = '<?php echo avatar(app('session')->get('user.profile.avatar'), app('session')->get('user.profile.idcard')); ?>', nickname = '<?php echo htmlentities(app('session')->get('user.profile.nickname')); ?>';
// 当前时间
window.now = function(){
    var date = new Date();
