<?php /*a:2:{s:66:"/www/wwwroot/sl.g8ym.com/application/index/view/funding/index.html";i:1630481919;s:65:"/www/wwwroot/sl.g8ym.com/application/index/view/common/world.html";i:1630392347;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<div class="d-flex mb-3">
    <select class="form-control custom-select w-auto" name="filter">
        <option value="all">Whole</option>
        <option value="invest">Participating</option>
        <option value="my">Published</option>
    </select>
	...
	<a class="btn px-5 btn-success ml-auto" href="/funding/welcome.html">Initiate crowdfunding</a>
</div>
<div class="card p-3">
