<?php /*a:2:{s:63:"/www/wwwroot/sl.g8ym.com/application/index/view/team/index.html";i:1629702693;s:65:"/www/wwwroot/sl.g8ym.com/application/index/view/common/world.html";i:1630392347;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
    ...
    <div class="col-6">
        <div class="card">
            <div class="card-body p-3 text-center">
                <div class="text-right text-green">people</div>
                <div class="h2 m-0"><?php echo htmlentities($user['dashboard']['team_count']); ?></div>
                <div class="small text-muted">Number of teams</div>
            </div>
        </div>
    </div>
    <div class="col-6">
        <div class="card">
            <div class="card-body p-3 text-center">
                ...
                <div class="small text-muted">Team computing power</div>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-sm-12 col-md-6 col-lg-4">
        <div class="form-group mb-3">
            <div class="input-group">
                ...
                <input type="text" class="form-control" placeholder="Search members..." name="key" maxlength="11" />
...
<div class="card">
    ...
    <div hidden class="card-footer text-center card-more"><div class="text-muted">more..</div></div>
</div>
