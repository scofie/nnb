<?php /*a:2:{s:66:"/www/wwwroot/sl.g8ym.com/application/admin/view/machine/index.html";i:1581830132;s:65:"/www/wwwroot/sl.g8ym.com/application/admin/view/common/world.html";i:1581830132;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
    ...
    <div class="row">
        <div class="col-md-6 col-lg-3 mb-3">
            <select class="form-control custom-select" name="product">
                ...
                <?php if(is_array($store) || $store instanceof \think\Collection || $store instanceof \think\Paginator): $i = 0; $__LIST__ = $store;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;if(app('request')->get('product') == $item['id']): ?>
                        <option value="<?php echo htmlentities($item['id']); ?>" selected="true"><?php echo htmlentities($item['title']); ?></option>
                    <?php else: ?>
...
<div class="card">
    <div class="table-responsive">
        <table class="table card-table table-vcenter">
            ...
            <tbody>
                <?php if(is_array($machines) || $machines instanceof \think\Collection || $machines instanceof \think\Paginator): $i = 0; $__LIST__ = $machines;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$machine): $mod = ($i % 2 );++$i;?>
                <tr>
                    <td>
                        <div><?php echo htmlentities($machine['nickname']); ?></div>
                        <div class="small text-muted"><?php echo htmlentities($machine['username']); ?></div>
                    </td>
                    <td>
                        <div><?php echo htmlentities($machine['mid']); ?></div>
                        <div class="small text-muted"><?php echo htmlentities($machine['name']); ?></div>
                    </td>
                    <td>
                        <div><?php echo htmlentities(number_format($machine['income']/$machine['cycle'],8,'.','')); ?></div>
                    ...
                    <td>
                        <div><?php echo htmlentities($machine['cycle']); ?>小时</div>
                        <div class="small text-muted"><?php echo htmlentities(money($machine['income'])); ?><?php echo htmlentities(app('config')->get('hello.unit')); ?></div>
                    </td>
                    <td><?php echo htmlentities(money($machine['price'])); ?><?php echo htmlentities(app('config')->get('hello.unit')); ?></td>
                    <td><?php echo htmlentities(money($machine['profit'])); ?><?php echo htmlentities(app('config')->get('hello.unit')); ?></td>
                    <td>
                        <div><?php echo htmlentities($machine['count']); ?></div>
                        <div class="small text-muted"><?php echo htmlentities($machine['profit_at']); ?></div>
                    </td>
                    <td>
                        <div><?php echo htmlentities($machine['create_at']); ?></div>
                        <div><?php echo htmlentities($machine['end_at']); ?></div>
                    </td>
                    <td><a href="/admin/machine/edit.html?id=<?php echo htmlentities($machine['mid']); ?>" class="icon"><i class="fe fe-edit"></i></a></td>
                </tr>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </tbody>
        </table>
    </div>
    <div class="card-footer"><?php echo $machines; ?></div>
</div>
