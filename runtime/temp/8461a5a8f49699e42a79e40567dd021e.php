<?php /*a:2:{s:67:"/www/wwwroot/sl.g8ym.com/application/index/view/account/authen.html";i:1630306720;s:65:"/www/wwwroot/sl.g8ym.com/application/index/view/common/world.html";i:1630392347;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
    ...
    <fieldset <?php echo $user['account']['authen']==1 || $user['account']['authen'] == 2 ? 'disabled'  :  ''; ?>>
            ...
            <div class="dimmer">
                ...
                <div class="dimmer-content">
                        <div class="card-title mb-4">
                            <div class="text-black mb-1">Real name authentication</div>
                            <div class="text-muted" style="font-size: .9rem;">Please fill in your information carefully</div>
                        </div>
                        <?php if($user['account']['authen'] == '0'): if(!(empty($user['profile']['authen_reason']) || (($user['profile']['authen_reason'] instanceof \think\Collection || $user['profile']['authen_reason'] instanceof \think\Paginator ) && $user['profile']['authen_reason']->isEmpty()))): ?>
                            ...
                            <div class="alert alert-success" role="alert">Congratulations, you have passed the real name certification!</div>
                        <?php endif; if($user['account']['authen'] == '2'): ?>
                            <div class="alert alert-warning" role="alert">Your information is under review. Please wait patiently！</div>
                        <?php endif; if(!(empty($audit) || (($audit instanceof \think\Collection || $audit instanceof \think\Paginator ) && $audit->isEmpty()))): ?>
                            <div class="alert alert-warning" role="alert">Your account has not been approved！</div>
                        <?php endif; ?>
                        <div class="form-group">
                            <label class="form-label">Personality nickname</label>
                            <input type="text" class="form-control" name="nickname" placeholder="Personality nickname" value="<?php echo htmlentities($user['profile']['nickname']); ?>" maxlength="10" />
                        </div>
                        <!-- <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="realname" placeholder="Consistent with the ID card" value="<?php echo htmlentities($user['profile']['realname']); ?>" />
                        </div>
                        <div class="form-group mb-0">
                            <label class="form-label">ID card No.</label>
                            <input type="text" class="form-control" name="idcard" placeholder="ID card No." value="<?php echo htmlentities($user['profile']['idcard']); ?>" />
                        </div>
                        ...
                        <div class="form-group mt-3 mb-0">
                            <div class="form-label">Front of ID card</div>
                            <div class="custom-file">
                        ...
                        <div class="form-group mt-3 mb-0">
                            <div class="form-label">Reverse side of ID card</div>
                            <div class="custom-file">
                        ...
                        <div class="form-group mt-3 mb-0">
                            <div class="form-label">Hand held ID card</div>
                            <div class="custom-file">
        ...
        <div class="card-footer text-right">
            <?php if(!(empty($audit) || (($audit instanceof \think\Collection || $audit instanceof \think\Paginator ) && $audit->isEmpty()))): ?>
                <button type="button" class="btn btn-primary" disabled="true">Submit certification</button>
            <?php else: ?>
                <button type="button" class="btn btn-primary">Submit certification</button>
            <?php endif; ?>
        </div>
    </fieldset>
</form>
