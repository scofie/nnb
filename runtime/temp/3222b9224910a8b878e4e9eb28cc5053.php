<?php /*a:2:{s:66:"/www/wwwroot/sl.g8ym.com/application/index/view/index/article.html";i:1581830132;s:65:"/www/wwwroot/sl.g8ym.com/application/index/view/common/world.html";i:1630392347;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<div class="card news">
    <div class="card-header">
        <h3 class="card-title"><?php echo htmlentities($article['title']); ?></h3>
    </div>
    <div class="card-body">
        <?php echo $article['content']; ?>
    </div>
    <div class="card-footer"><?php echo htmlentities($article['date']); ?></div>
</div>
...
require(['jquery'], function($){
	$(function(){
		$('.card-body table').addClass('table table-bordered');
	});
});
</script>
