<?php /*a:2:{s:66:"/www/wwwroot/sl.g8ym.com/application/index/view/wallet/record.html";i:1630304331;s:65:"/www/wwwroot/sl.g8ym.com/application/index/view/common/world.html";i:1630392347;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<div class="d-flex">
    ...
    <div class="text-muted mt-2 ml-3 small">total：<span class="total"></span><span class="unit"></span></div>
</div>
<div class="card">
    ...
    <div hidden class="card-footer card-more"><div class="text-center">more</div></div>
</div>
...
var currency = '<?php echo htmlentities(app('request')->get('c')); ?>';
var business = '<?php echo htmlentities(app('request')->get('t')); ?>';
</script>
