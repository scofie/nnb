<?php /*a:2:{s:64:"/www/wwwroot/sl.g8ym.com/application/admin/view/store/index.html";i:1581830132;s:65:"/www/wwwroot/sl.g8ym.com/application/admin/view/common/world.html";i:1581830132;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
        ...
        <tbody>
            <?php if(is_array($store) || $store instanceof \think\Collection || $store instanceof \think\Paginator): $i = 0; $__LIST__ = $store;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$product): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td><?php echo htmlentities((isset($product['username']) && ($product['username'] !== '')?$product['username']:'官方')); ?></td>
                    <td><?php echo htmlentities(app('config')->get('hello.store.catalog')[$product['catalog']]); ?></td>
